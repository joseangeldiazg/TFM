...
A continuación, haremos una breve introducción a la motivación y problema a resolver, continuaremos con la puntualización de los objetivos principales del proyecto de fin de máster y concluiremos la sección dando al lector una idea de la organización final de la memoria. 

\section{Motivación}

El ámbito que nos incumbe y que aúna,  técnicas de minería de datos, redes sociales y en cierta medida Big Data, es relativamente nuevo, debido sin duda alguna a la novedad que las redes sociales ofrecen. Por poner algún ejemplo, Twitter fue fundada en el año 2006 y Facebook en el 2005, lo que nos da una media de unos 11 años de vida en las redes sociales más famosas, antiguas y usadas. Por otro lado, debemos tener en cuenta que su implantación y comercialización en la sociedad no tuvo lugar el mismo día de fundación por lo que su `edad' sería aún menor. 
...
\begin{itemize}
	...
	\item Aplicación de técnicas basadas en reglas de asociación para obtener patrones interesantes en los datos. 
