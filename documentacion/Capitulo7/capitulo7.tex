...
El histograma realizado puede verse en el gráfico \ref{histsent}, donde parece que  un número muy elevado de tuits hablan de \textbf{veracidad o afirmaciones}. Esto es normal ya que en twitter mucha gente afirma hechos o noticias por lo que era de esperar que este sentimiento fuera el mayoritario. Por otro lado,  vemos que la \textbf{diversión} o el agrado tiene también una gran representación. Del mismo modo ocurre con la \textbf{anticipación}, este último debe ser analizado para ver que términos se asocian con anticipación, ya que es ambiguo. El resto de los sentimientos están mas o menos equilibrados y frente a lo que cabría esperar de encontrarnos una sociedad enfadada o molesta parece que estos sentimientos están por detrás de otros más amables. 
