...
Como podemos observar, estas limitaciones pueden suponer un gran problema a la hora de obtener una gran cantidad de datos para que nuestro trabajo tenga un cierto rigor y peso, por ello, en el punto siguiente ahondaremos en el proceso seguido y tecnologías usadas para la obtención de un gran volumen de datos a pesar de estas restricciones. 
